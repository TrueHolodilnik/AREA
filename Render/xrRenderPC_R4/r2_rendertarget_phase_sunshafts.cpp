...
void	CRenderTarget::phase_ogse_sunshafts()
{
    ...
    */
    // Set RT's
	u_setrt(rt_sunshafts_0, 0, 0, 0, HW.pBaseZB);
    ...
    // Draw COLOR
    RCache.set_Element(s_ogse_sunshafts->E[0]);
    ...
    */
    // Set RT's
	u_setrt(rt_sunshafts_1, 0, 0, 0, HW.pBaseZB);
    RCache.set_CullMode(CULL_NONE);
    RCache.set_Stencil(FALSE);
    ...
    // Draw COLOR
    RCache.set_Element(s_ogse_sunshafts->E[1]);
    ...
    */
    ...
    // Draw COLOR
    RCache.set_Element(s_ogse_sunshafts->E[2]);
    RCache.set_c("c_sunshafts", params);
    RCache.set_Geometry(g_KD);
    RCache.Render(D3DPT_TRIANGLELIST, Offset, 0, 4, 0, 2);
    ...
    */
    ...
    // Draw COLOR
    RCache.set_Element(s_ogse_sunshafts->E[3]);
    RCache.set_c("c_sunshafts", params);
    RCache.set_Geometry(g_KD);
    RCache.Render(D3DPT_TRIANGLELIST, Offset, 0, 4, 0, 2);
    ...
    */
    // Set RT's
	u_setrt(rt_Generic, 0, 0, 0, HW.pBaseZB);
    RCache.set_CullMode(CULL_NONE);
    RCache.set_Stencil(FALSE);
    ...
    // Draw COLOR
    RCache.set_Element(s_ogse_sunshafts->E[4]);
    RCache.set_c("c_sunshafts", params);
    RCache.set_Geometry(g_KD);
    RCache.Render(D3DPT_TRIANGLELIST, Offset, 0, 4, 0, 2);
