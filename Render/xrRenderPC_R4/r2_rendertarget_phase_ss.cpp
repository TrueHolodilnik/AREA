...
void	CRenderTarget::phase_SunShafts	()
{
	...
	//Set RT's
	u_setrt			(	rt_SunShaftsMask,0,0,0,HW.pBaseZB	)	;
	...
	//////////////////////////////////////////////////////////////////////////////////////////
	//SUNSHAFTS SMOOTHED MASK
	//////////////////////////////////////////////////////////////////////////////////////////
	
	//Set RT's
	u_setrt			(	rt_SunShaftsMaskSmoothed,0,0,0,HW.pBaseZB	)	;
	RCache.set_CullMode		( CULL_NONE )	;
	RCache.set_Stencil		( FALSE		)	;
	...
	//Set RT's
	u_setrt			(	rt_SunShaftsPass0,0,0,0,HW.pBaseZB	)	;
	RCache.set_CullMode		( CULL_NONE )	;
	RCache.set_Stencil		( FALSE		)	;
