...
//-Alundaio
extern ECORE_API BOOL ps_mask_control;
extern ECORE_API BOOL ps_drops_control;
extern ECORE_API BOOL ps_sslr_control;
extern ECORE_API BOOL ps_postprocess_control;
extern ECORE_API BOOL ps_chrom_abberation_control;
extern ECORE_API BOOL ps_bloom_control;
extern ECORE_API BOOL ps_dof_chrabb;
extern ECORE_API BOOL ps_sky_rainbow;
extern ECORE_API BOOL ps_water_ripples;
extern ECORE_API BOOL ps_water_mudfoam;
extern ECORE_API BOOL ps_metall_refls;
extern ECORE_API BOOL ps_vignette;
extern ECORE_API BOOL ps_fake_tonemap;
...
extern ECORE_API	u32			ps_pom_quality;			//	=	0;
extern ECORE_API	xr_token	pom_token[];
...
extern ECORE_API float	        ps_script_wetness;
...
extern ECORE_API float	        ps_techni_amount;
extern ECORE_API float	        ps_techni_power;
extern ECORE_API float	        ps_techni_red;
extern ECORE_API float	        ps_techni_green;
extern ECORE_API float	        ps_techni_blue;
extern ECORE_API float	        ps_chrom_abb_factor;
extern ECORE_API float	        ps_chrom_abb_power;
extern ECORE_API float	        ps_hdr_factor;
extern ECORE_API float	        ps_luma_factor;
extern ECORE_API float	        ps_luma_power;
extern ECORE_API int	        ps_luma_pattern;
extern ECORE_API float	        ps_luma_offset;
extern ECORE_API float	        ps_dpx_red;
extern ECORE_API float	        ps_dpx_green;
extern ECORE_API float	        ps_dpx_blue;
extern ECORE_API float	        ps_dpx_color_gamma;
extern ECORE_API float	        ps_dpx_saturation;
extern ECORE_API float	        ps_dpx_power;
extern ECORE_API int	        ps_curves_formula;
extern ECORE_API float	        ps_curves_contrast;
extern ECORE_API int	        ps_sslr_samples;
extern ECORE_API float			ps_vignette_power;
...
enum
{
	...
	R2FLAG_MBLUR				= (1<<6),
	R2FLAG_GI					= (1<<7),
	R2FLAG_FASTBLOOM			= (1<<8),
	R2FLAG_GLOBALMATERIAL		= (1<<9),
	R2FLAG_ZFILL				= (1<<10),
	R2FLAG_R1LIGHTS				= (1<<11),
	R2FLAG_SUN_IGNORE_PORTALS	= (1<<12),
