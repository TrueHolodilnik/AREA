...
static const int	max_desired_items	= 5000;
static const float	source_radius		= 25.f;
static const float	source_offset		= 80;
static const float	max_distance		= source_offset*1.25f;
static const float	sink_offset			= -(max_distance-source_offset);
static const float	drop_length			= 2.f;
static const float	drop_width			= 0.20f;
