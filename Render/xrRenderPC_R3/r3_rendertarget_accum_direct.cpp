...
// blend-copy
	if (!RImplementation.o.fp16_blend)	{
      ...
      if( ! RImplementation.o.dx10_msaa )
		  ...
		  u_setrt(rt_Accumulator, NULL, NULL, NULL, rt_MSAADepth->pZRT);
...
// Select target
	...
	if( ! RImplementation.o.dx10_msaa )
		...
		u_setrt(rt_Generic_0_r, NULL, NULL, NULL, RImplementation.Target->rt_MSAADepth->pZRT);
	...
	// Perform lighting
	{
		if( ! RImplementation.o.dx10_msaa )
			...
			u_setrt(rt_Generic_0_r, NULL, NULL, NULL, RImplementation.Target->rt_MSAADepth->pZRT);  // enshure RT setup
		RCache.set_CullMode					(CULL_NONE	);
		RCache.set_ColorWriteEnable			();
