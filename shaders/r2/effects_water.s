...
local tex_leaves              = "water\\water_ryaska1"
...
function normal                (shader, t_base, t_second, t_detail)
  ...
  shader:sampler        ("s_nmap_leaves")       :texture  (tex_leaves_nmap)
  ...
  shader:sampler        ("s_foam")     :texture  (tex_foam) : wrap()	:f_anisotropic()
  shader:sampler        ("s_mud")     :texture  (tex_mud) : wrap()	:f_anisotropic()
