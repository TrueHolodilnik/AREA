...
half 	shadow_hw	(float4 tc)		{
	...
	for (int i = 1; i <= n; i++)
	{
		s0 += sample_hw_pcf(tc, float4(-i * 1, -i * 1, 0, 0));
		s0 += sample_hw_pcf(tc, float4(+i * 1, -i * 1, 0, 0));
		s0 += sample_hw_pcf(tc, float4(-i * 1, +i * 1, 0, 0));
		s0 += sample_hw_pcf(tc, float4(+i * 1, +i * 1, 0, 0));
		s0 += sample_hw_pcf(tc, float4(0, +i * 1, 0, 0));
		s0 += sample_hw_pcf(tc, float4(0, -i * 1, 0, 0));
		s0 += sample_hw_pcf(tc, float4(+i * 1, 0, 0, 0));
		s0 += sample_hw_pcf(tc, float4(-i * 1, 0, 0, 0));
...
half 	shadow_hw_f4	(float4 tc)		{
	...
	for (int i = 1; i <= n; i++)
	{
		s0 += sample_hw_f4(tc, float4(-i * 1, -i * 1, 0, 0));
		s0 += sample_hw_f4(tc, float4(+i * 1, -i * 1, 0, 0));
		s0 += sample_hw_f4(tc, float4(-i * 1, +i * 1, 0, 0));
		s0 += sample_hw_f4(tc, float4(+i * 1, +i * 1, 0, 0));
		s0 += sample_hw_f4(tc, float4(0, +i * 1, 0, 0));
		s0 += sample_hw_f4(tc, float4(0, -i * 1, 0, 0));
		s0 += sample_hw_f4(tc, float4(+i * 1, 0, 0, 0));
		s0 += sample_hw_f4(tc, float4(-i * 1, 0, 0, 0));
