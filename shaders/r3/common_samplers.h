...
Texture2D s_SSLR; // DEBUG
Texture2D s_wetness; // DEBUG
Texture2D s_puddles; // DEBUG
...
//uniform sampler2D       s_depth;                //
		...
		Texture2DMS<float4,MSAA_SAMPLES>	s_normal;      	// rgb.a = diffuse.specular
		...
		Texture2DMS<float4>	s_normal;      	// rgb.a = diffuse.specular
